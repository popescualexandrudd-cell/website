...
export const strings = {
  ro: {
    ...
    confirmed: {
      subject: (code: string) => `Antrenamentul e confirmat (${code})`,
      preview: "Ne vedem pe teren.",
      title: "Antrenamentul e confirmat.",
    ...
    cancelledClient: {
      ...
      bodyByCoach:
        "Ne pare rău, dar trebuie să anulăm acest antrenament. Scrie-ne sau alege altă oră din pagina de rezervare, iar dacă ai plătit în avans, îți returnăm suma.",
      reason: "Motiv",
      bookAgain: "Alege altă oră",
    },
    reminder: {
      subject: (code: string) => `Mâine ai antrenament de tenis (${code})`,
      preview: "Un memento scurt.",
      title: "Ne vedem mâine.",
      body: "Un memento scurt pentru antrenamentul de mâine. Dacă plouă tare, te anunțăm din timp.",
    },
    review: {
      subject: "Cum a fost primul antrenament?",
      preview: "Două minute, dacă ai chef.",
      title: "Cum a fost primul antrenament?",
      body: "Dacă ai două minute, câteva rânduri despre primul antrenament îi ajută pe alții să aleagă. Recenzia apare pe site doar dacă îți dai acordul.",
    ...
    giftCard: {
      ...
      body: "Mulțumim! Cardul de mai jos e activ. Îl poți tipări sau trimite mai departe; cine îl primește își rezervă antrenamentul pe site, cu codul de pe card, sau la telefon.",
    ...
    newsletter: {
      ...
      body: "Apasă butonul de mai jos ca să primești un email când avem locuri libere sau noutăți de la club. Dacă nu tu ai cerut abonarea, ignoră acest mesaj.",
  ...
  en: {
    ...
    confirmed: {
      subject: (code: string) => `Your session is confirmed (${code})`,
    ...
    cancelledClient: {
      ...
      bodyByCoach:
        "We are sorry, but we have to cancel this session. Write to us or choose another time on the booking page; if you paid in advance, we will refund you.",
      reason: "Reason",
      bookAgain: "Choose another time",
    },
    reminder: {
      subject: (code: string) => `Tennis session tomorrow (${code})`,
      preview: "A short reminder.",
      title: "See you tomorrow.",
      body: "A short reminder about tomorrow's session. If it rains heavily, we will let you know in good time.",
    },
    review: {
      subject: "How was your first session?",
      preview: "Two minutes, if you feel like it.",
      title: "How was your first session?",
      body: "If you have two minutes, a few lines about your first session help others choose. The review appears on the site only with your consent.",
    ...
    giftCard: {
      ...
      body: "Thank you! The card below is active. Print it or pass it on; whoever receives it books the session on the site with the code on the card, or by phone.",
    ...
    newsletter: {
      ...
      body: "Press the button below to get an email when we have free places or news from the club. If you did not ask to subscribe, ignore this message.",
...
export const coachStrings = {
  ...
  evaluation: {
    subject: (name: string) => `Înscriere copil (2 ședințe gratuite): ${name}`,
    title: "Înscriere nouă la grupele de inițiere (2 ședințe gratuite)",
