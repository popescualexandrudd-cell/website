...
const scene: Resource = {
  ...
  model: "scene",
  entity: "Scene",
  label: "Scenele paginii principale",
  singular: "scena",
  description:
    "Cele zece scene ale paginii principale: texte, picturi, poziția textului, mingea și tranzițiile.",
  section: "Pagina principală",
  orderable: true,
  listOrderBy: { order: "asc" },
  title: (r) => `${ro(r.indexName)} · ${ro(r.title)}`,
  meta: (r) => `Tranziție: ${optionLabel(TRANSITIONS, str(r.transition))}`,
  flags: (r) => (yes(r.active) ? [] : ["ascunsă"]),
  publicPath: () => "/",
  fieldFilter: (field, row) => field.name !== "extra" || str(row?.key) === "locurile",
  fields: [
    {
      kind: "i18n",
      name: "indexName",
      label: "Numele din index",
      help: "Cuvântul scurt din coloana de navigare a scenelor.",
      required: true,
      group: "Texte",
      maxLength: 40,
    },
    { kind: "i18n", name: "title", label: "Titlu", required: true, group: "Texte", maxLength: 160 },
    { kind: "i18nText", name: "body", label: "Text", required: true, group: "Texte", rows: 4 },
    {
      kind: "i18n",
      name: "ctaLabel",
    ...
    },
    {
      kind: "art",
      name: "artKey",
      label: "Pictura (din setul de imagini)",
      required: true,
      group: "Imagine",
    },
    {
      kind: "media",
      name: "imageId",
      label: "Imagine încărcată (înlocuiește pictura)",
      help: "Lățime recomandată 2560 px, format 16:9.",
      nullable: true,
      group: "Imagine",
    },
    {
      kind: "media",
      name: "imageMobileId",
      label: "Varianta pentru telefon",
      help: "Format vertical 9:16, 1080 × 1920 px.",
      nullable: true,
      group: "Imagine",
    },
    {
      kind: "art",
      name: "artKeySecondary",
      label: "A doua pictură (tranziții în două timpi)",
      nullable: true,
      group: "Imagine",
    },
    {
      kind: "media",
      name: "imageSecondaryId",
      label: "A doua imagine încărcată",
      nullable: true,
      group: "Imagine",
    },
    {
      kind: "media",
      name: "imageSecondaryMobileId",
      label: "A doua imagine, pentru telefon",
      nullable: true,
      group: "Imagine",
    },
    {
      kind: "i18nText",
      name: "imageAlt",
      label: "Descrierea imaginii (text alternativ)",
      help: "Ce se vede în imagine, pentru cei care nu o pot vedea.",
      required: true,
      group: "Imagine",
      rows: 2,
    },
    {
      kind: "enum",
      name: "textPosDesktop",
      label: "Poziția textului pe ecran mare",
    ...
    },
    {
      kind: "enum",
      name: "textPosMobile",
      label: "Poziția textului pe telefon",
      options: TEXT_POSITIONS,
      group: "Așezare",
    },
    {
      ...
      options: [
        { value: "INCHIS", label: "Închisă (pe imagini luminoase)" },
        { value: "DESCHIS", label: "Deschisă (pe imagini întunecate)" },
      ],
      group: "Așezare",
    },
    {
      kind: "bool",
      name: "veil",
      label: "Voal discret sub text",
      help: "Bifează dacă textul se citește greu peste imagine.",
      group: "Așezare",
    },
    {
      kind: "float",
      name: "ballX",
      label: "Mingea: poziția pe orizontală",
      help: "Între 0 (stânga) și 1 (dreapta).",
      min: 0,
      max: 1,
      step: 0.01,
      group: "Mingea aurie",
    },
    {
      kind: "float",
      name: "ballY",
      label: "Mingea: poziția pe verticală",
      help: "Între 0 (sus) și 1 (jos).",
      min: 0,
      max: 1,
      step: 0.01,
      group: "Mingea aurie",
    },
    {
      kind: "float",
      name: "ballSize",
      label: "Mingea: mărimea",
      help: "Partea din lățimea ecranului, de exemplu 0,05.",
      min: 0.01,
      max: 0.5,
      step: 0.005,
      group: "Mingea aurie",
    },
    {
      kind: "enum",
      name: "transition",
      label: "Tranziția către scena următoare",
      options: TRANSITIONS,
      group: "Mingea aurie",
    },
    { kind: "bool", name: "active", label: "Afișează scena", group: "Publicare" },
  ],
};
...
const program: Resource = {
  ...
  fields: [
    ...
    },
    {
      kind: "art",
      name: "artKey",
      label: "Ilustrația (din setul de imagini)",
      nullable: true,
      group: "Imagine",
    },
    {
      kind: "media",
      name: "imageId",
      label: "Fotografie încărcată (înlocuiește ilustrația)",
      nullable: true,
      group: "Imagine",
    },
...
const profile: Resource = {
  ...
  fields: [
    ...
    },
    {
      ...
      name: "photoId",
      label: "Fotografia ta",
      help: "Portret vertical, bine luminat.",
      nullable: true,
      group: "Profil",
    },
    {
...
const pageHeader: Resource = {
  ...
  singular: "antetul",
  description: "Titlul, textul introductiv și imaginea din capul fiecărei pagini interioare.",
  section: "Pagina principală",
  listOrderBy: { key: "asc" },
  ...
  fields: [
    ...
    { kind: "art", name: "artKey", label: "Pictura", nullable: true, group: "Imagine" },
    {
      kind: "media",
      name: "imageId",
      label: "Imagine încărcată (înlocuiește pictura)",
