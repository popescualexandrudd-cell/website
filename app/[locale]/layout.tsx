...
const SEARCH_KEYWORDS = {
  ro: [
    ...
    "cursuri tenis copii Ilfov",
    "antrenor tenis Pantelimon",
    "mini tenis copii 4 ani",
    "tenis pentru copii București",
    "terenuri de tenis acoperite Pantelimon",
    "tenis pe zgură iarna",
    "lecții tenis adulți începători",
    "pregătire tenis competiție juniori",
    "Elite Tenis Club",
  ],
  en: [
